...
face_cascade = cv2.CascadeClassifier("learn_project\haarcascade_frontalface_default.xml")
eye_cascade = cv2.CascadeClassifier("learn_project\haarcascade_eye_tree_eyeglasses.xml")

#read images
witch = cv2.imread('learn_project\images\glasses.png')
...
while True:   #continue to run until user breaks loop
    ...
    for (x,y,w,h) in faces:
        ...
        witch_y1 = face_y1 - int(face_h*0.3)
